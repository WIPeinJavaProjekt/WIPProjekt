                    ...
                    <fieldset>
                        ...
                        <div class="pure-g" id="searchbar">
                            ...
                            <div class="pure-u-3-5">
                                <input type="text" name="searchArticlePattern" maxlength="255" class="boxedinput" placeholder="Artikelinformationen eingeben">
                            </div>
                            <div class="pure-u-1-5">
            ...
            <c:if test="${ not empty articles }">
                ...
                <c:forEach var="article" items="${articles}">
                    <div>
                        ...
                        <div class="pure-g">
                            <div class="pure-u-1-4">
                                <p><b>${article.getId()}</b></p>
                            </div>
                            <div class="pure-u-1-4">
                                <p>${article.getManufacturer()}</p>
                            </div>
                            <div class="pure-u-1-4">
                                <p>${article.getName()}</p>
                            </div>
