<!-- 
Beschreibung: Bestellbestätigung
            ...
            <div class="pure-g content-container">
                <div class="pure-u-1-1">
                    ...
                    <div class="pure-u-6-8 fullwidth">
                        <center>
                            <h1>
                                <b>Vielen Dank für Ihre Bestellung bei  <img id="branding" src="./Images/brand.png" height="135px" width="auto"></b><br>Wir hoffen Sie bald wieder als Kunden in unserem <a href="./start">Onlineshop</a> begrüßen zu dürfen.<br>Bis
                                dahin wünschen wir Ihnen ganz viele außergewöhnliche Ski-Erlebnisse.
                            </h1>
                            <h3>
