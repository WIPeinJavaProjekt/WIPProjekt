    ...
    <center>
        <div class="search-results">
            <c:if test="${ not empty orders && currentUser.utid == 1 || not empty orders && currentUser.utid == 3}">
                ...
                <c:forEach var="order" items="${orders}">
                    <div>
                        <hr>
                        <div class="pure-g">
                            <div class="pure-u-1-5 overflowhider">
                                <p><b>${order.getOrid()}</b></p>
                            </div>
                            <div class="pure-u-1-5 overflowhider">
            ...
            <c:if test="${ not empty orders && currentUser.utid == 2 }">
                <div class="pure-g">
                    <div class="pure-u-1-4 textbox">
                        <p><b>Bestellnummer</b></p>
                    </div>
                    <div class="pure-u-1-4 textbox">
                        <p><b>Status</b></p>
                    </div>
                    <div class="pure-u-1-4 textbox">
                        <p><b>Bestelldatum</b></p>
                    </div>
                </div>
                <c:forEach var="order" items="${orders}">
                    <div>
