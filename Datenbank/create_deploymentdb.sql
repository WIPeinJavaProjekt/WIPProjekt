...
ALTER TABLE SHOPPINGCART ADD COLUMN acolid int;
ALTER TABLE SHOPPINGCART ADD FOREIGN KEY(acolid) REFERENCES ARTICLECOLOR(acolid);
...
ALTER TABLE STOCK ADD COLUMN acolid int;
ALTER TABLE STOCK ADD FOREIGN KEY(acolid) REFERENCES ARTICLECOLOR(acolid) ON DELETE CASCADE;
