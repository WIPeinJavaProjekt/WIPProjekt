...
ALTER TABLE ASSIGNMENTSTATUS ADD FOREIGN KEY(orid) REFERENCES ASSIGNMENT(orid);
...
ALTER TABLE ASSIGNMENTDETAILS ADD FOREIGN KEY(orid) REFERENCES ASSIGNMENT(orid);
ALTER TABLE ASSIGNMENTDETAILS ADD COLUMN avid int;
ALTER TABLE ASSIGNMENTDETAILS ADD FOREIGN KEY(avid) REFERENCES ARTICLEVERSION(avid);
